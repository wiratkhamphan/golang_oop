...
func (r customerRepositoryMock) Save(Customer) (*Customer, error) {
	panic("unimplemented")
}

// PosByid implements CustomerRepository.
func (r customerRepositoryMock) PosByid(Customer) (*Customer, error) {
	panic("unimplemented")
}
